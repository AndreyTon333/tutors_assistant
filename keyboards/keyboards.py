...
# в ознакомительных целях можно протестировать бота и в режиме администратора, и в режиме обычного пользователя
# клавиатура для этого с кнопками 'Администратор' и 'Пользователь'
def kb_admin_user_test() -> InlineKeyboardMarkup:

    logging.info('kb_admin_user_test')
    button_admin = InlineKeyboardButton(text='Администратор',
                                        callback_data='admin_test')
    button_user = InlineKeyboardButton(text='Пользователь',
                                       callback_data='user_test')
    keyboard = InlineKeyboardMarkup(
        inline_keyboard=[
            [button_admin], [button_user]
        ]
    )
    return keyboard

def kb_admin_token_test() -> InlineKeyboardMarkup:

    logging.info('kb_admin_user_test')
    button_admin = InlineKeyboardButton(text='Администратор проекта',
                                        callback_data='admin_test')
...
def kb_name_chapter_dz(prefix: str | None=None) -> InlineKeyboardMarkup:
